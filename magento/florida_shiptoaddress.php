...
<?php 
	if(isset($_POST['btnExport'])){
		...
		fputcsv($file,array('Order Id','Customer Name','Ship to Address','Ship to city','Ship to zip','Ship to State','Ship to country','Total Tax','Grand Total'));
		foreach ($_orderCollection as $order) {
			...
			if(trim($shipToState) == 'Florida'){
				fputcsv($file,array($orderId,$customerName,$shipToAddress,$shipToCity,$shipToZip,$shipToState,$shipToCountry,$totalTax,$grandTotal));	
			}
			$cnt++;
		}
		fclose($file);
