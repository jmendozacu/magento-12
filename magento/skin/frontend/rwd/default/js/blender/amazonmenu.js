	...
	setupmenu:function($menu, setting){
		...
		$topul.find('li>div, li>ul').each(function(){ // find drop down elements
			...
			$dropdown
				...
				.on('mouseleave' + addevtstring(setting.hidemenuonclick || amazonmenu.touchenabled), function(e){
					if ($j(this).data('fullyvisible') == true){
						amazonmenu.showhide($j(this).data('$parentli'), 'hide', setting)
					}
					if (e.type == 'click'){
						e.stopPropagation()
					}
