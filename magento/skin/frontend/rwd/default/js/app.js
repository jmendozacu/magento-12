...
$j(document).ready(function () {
    ...
    var skipLinks = $j('#cart-header');
    var elem = '';
    skipLinks.hover(function(e){
        ...
        if(isSkipContentOpen == 0){
            $j('.youama-login-window').hide();
    ...
    skipContents.mouseleave(function() {
        elem.hide();
        skipLinks.removeClass('skip-active');
        skipContents.removeClass('skip-active');
        $j('#myaccountdj').removeClass('skip-active');
    ...
    var skipLinksnav = $j('#header-nav-link');
    var skipContentsnav = $j('.skip-content-nav');

    skipLinksnav.on('click', function (e) {
        e.preventDefault();

        skipLinkssearch.removeClass('skip-active');
        skipContentssearch.removeClass('skip-active');
        ...
        // Hide all stubs
        skipLinksnav.removeClass('skip-active');
        skipContentsnav.removeClass('skip-active');
    ...
    var skipLinkssearch = $j('#header-search-link');
    var skipContentssearch = $j('.skip-content-search');
