...
class MW_Onestepcheckout_Helper_Data extends Mage_Core_Helper_Abstract
{
  ...
  const LAYOUT_FILE = 'mw_onestepcheckout.xml';
  // Define template folder name
  const TEMPLATE_FOLDER = 'mw_onestepcheckout';
  ...
  public function getPlatform()
   ...
   //default enable_giftmessage is disable
    ...
    public function checkMissingLayoutCurrentThemeViaFrontend()
    {
        ...
        if($flag == false) {
            // If cannot find, display error message
            $message = $this->__('One Step Checkout Pro: Missing layout file or template folder of this module. Please follow the install instruction at <a href="http://www.mage-world.com/wiki/index.php?title=OnestepCheckoutPro-installation-upgrade" target="_blank">here</a> or you can submit a ticket at <a href="http://www.mage-world.com/contacts/" target="_blank">here</a>');
    ...
    public function checkMissingLayoutThemesViaBackend()
    {
        ...
        $message = 'One Step Checkout Pro: Missing layout file or template folder of this module. Please follow the install instruction at <a href="http://www.mage-world.com/wiki/index.php?title=OnestepCheckoutPro-installation-upgrade" target="_blank">here</a> or you can submit a ticket at <a href="http://www.mage-world.com/contacts/" target="_blank">here</a>';
        $countError = 0;
