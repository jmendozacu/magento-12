...
class Mage_Catalog_Model_Resource_Product_Collection extends Mage_Catalog_Model_Resource_Collection_Abstract
{
     ...
     */
    public function addOrderedQtyNew($from = '', $to = '', $currentCategoryId)
    {
        $adapter              = $this->getConnection();
        ...
        $compositeTypeIds = array('grouped','bundle');
     ...
     * @return Mage_Reports_Model_Resource_Product_Collection
     */
    public function setOrderNew($attribute, $dir = self::SORT_ORDER_DESC)
    {
