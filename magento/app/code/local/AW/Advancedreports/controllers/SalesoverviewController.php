...
class AW_Advancedreports_SalesoverviewController extends AW_Advancedreports_Controller_Action
{
    ...
    public function indexAction()
    {
        $this->loadLayout()
            ...
            ->_addContent($this->getLayout()->createBlock('advancedreports/advanced_salesoverview'))
            ->renderLayout();
    }
    ...
    public function exportCsvAction()
    {
        ...
        $content = $this->getLayout()->createBlock('advancedreports/advanced_salesoverview_grid')->setIsExport(true)
            ->getCsv();
