...
class AW_Advancedreports_Additional_ReportController extends AW_Advancedreports_Controller_Action
{
    ...
    {
        return Mage::helper('advancedreports/additional')->getVersionCheck($name);
    }
    ...
    public function exportOrderedCsvFileAction()
    {
        $this->_initAddName();
        $fileName = $this->_getName() . '.csv';
        $content = $this->getLayout()
    ...
    public function exportOrderedExcelFileAction()
    {
        $this->_initAddName();
        $fileName = $this->_getName() . '.xml';
        $content = $this->getLayout()
