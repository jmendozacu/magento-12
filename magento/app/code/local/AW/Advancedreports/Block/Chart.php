...
class AW_Advancedreports_Block_Chart extends Mage_Adminhtml_Block_Template
{
    ...
    public function setBackgroundColor($backgroundCode)
    {
        $this->_backgroundColor = $backgroundCode;
        return $this;
    }
    ...
    public function getBackgroundColor()
    {
        if (!$this->_backgroundColor) {
            $this->_backgroundColor = Mage::helper('advancedreports')->getChartBackgroundColor();
        }
