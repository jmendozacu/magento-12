...
class Posixtech_NetworkMerchants_Model_PaymentMethod extends Mage_Payment_Model_Method_Cc
{
    ...
    protected function _buildRequest(Varien_Object $payment)
    {
        ...
        //get and set merchant defined field
        $mdf03 = $this->getConfigData('mdf03');
        if ($mdf03) {
            $request->setMerchantDefinedField03($mdf03);
        }
    ...
    public function doSale($request) {
        ...
        $query .= "merchant_defined_field_3=" . urlencode($request->getMerchantDefinedField03()) . "&";
        ...
        Mage::log('Payment Request QUERY:',null,'nmi.log');
        Mage::log($query,null,'nmi.log');

        $result = $this->_doPost($query);
        
        Mage::log('Payment Response:',null,'nmi.log');
        Mage::log($result,null,'nmi.log');
