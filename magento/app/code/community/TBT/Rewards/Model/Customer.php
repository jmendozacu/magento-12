...
class TBT_Rewards_Model_Customer extends Mage_Customer_Model_Customer
{
    ...
    /**
     * Implementing getter for 'rewards_points_notification' customer attribute to overwrite default for old customers
     * prior to ST 1.7.5
     *
     * @return int|mixed
     */
    public function getRewardsPointsNotification()
    {
        if (!$this->hasRewardsPointsNotification()) {
            return 1;
        }

        return $this->getData('rewards_points_notification');
    }
}
