...
class TBT_Rewards_Model_Transfer extends TBT_Rewards_Model_Abstract
{
    ...
    public function _beforeSave()
    {
        ...
        if ($this->getCustomerId () == null || $this->getCustomerId () == '') {
            throw new Exception ("You will receive 25 points if there is account exists with this Email Address");
        }
    ...
    /**
     * Getter for the transfer '_isResave' flag.
     *
     * @return bool
     */
    public function getIsResave()
    {
        return $this->_isResave;
    }
