...
Mage::log('Drop Ship CronJob started',null,'dropship.log');
Mage::log('GMT Time Now : '.date('Y-m-d H:i:s'),null,'dropship.log');


$cronExpectedRunTime = '04:00:00'; // 12PM EST = 4AM GMT = 04:00:00
$cronRunAfterHours = 24;
if(date('Y-m-d') == '2015-08-28'){
    $cronRunAfterHours = 22;
}
...
$cronExpectedRunDateTime = date('Y-m-d '.$cronExpectedRunTime);
//$expectedRun = date('Y-m-d H:i:s', strtotime('+'.$cronRunAfterHours.' hours',strtotime($toDateTime)));

//Mage::log('Expected Run Date Time : '.$cronExpectedRunDateTime,null,'dropship.log');
Mage::log('Expected Run : '.$cronExpectedRunDateTime,null,'dropship.log');

///if(strtotime($currentDateTime) > strtotime($expectedRun)){
if(date('H') == '20'){
...
Mage::log('Drop Ship CronJob Ended',null,'dropship.log');
